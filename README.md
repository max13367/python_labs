...
### тестовый инпут
![фото1 7](./images/lab08/02.png)

### Вывод после кода
![фото1 7](./images/lab08/03.png)

### Ошибка недопустимого количества баллов
![фото1 7](./images/lab08/04.png)

### Ошибка недопустимой даты рождения
![фото1 7](./images/lab08/05.png)
...
### Вывод списка
![фото1 9](./images/lab09/01.png)

### Поиск и добавление студента
![фото1 9](./images/lab09/02.png)

### Статистика студентов
![фото1 9](./images/lab09/03.png)

## Лабораторная работа №10  
**Тема:** Структуры данных: Stack, Queue, Singly Linked List

---

## Цель работы

Реализовать базовые структуры данных (стек, очередь и односвязный список),
изучить их основные операции и понять их асимптотическую сложность.
...
Стек — структура данных, работающая по принципу **LIFO**
(Last In — First Out).
...
Для реализации используется `collections.deque`, так как он
обеспечивает эффективные операции добавления и удаления с обоих концов.
...
- добавление в конец (при наличии `tail`) — **O(1)**
- вставка или удаление по индексу — **O(n)**
- обход списка — **O(n)**

---

## Задание 1 — Stack и Queue

Реализованы классы `Stack` и `Queue`.

Пример использования:

![фото1 10](./images/lab10/01.png)

Задание 2 — SinglyLinkedList
Реализованы классы Node и SinglyLinkedList.
...
![фото1 10](./images/lab10/02.png)


Выводы

В ходе работы были изучены принципы работы базовых структур данных
и их асимптотическая сложность.